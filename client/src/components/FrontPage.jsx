      ...
      <div className="flex justify-between mtb:items-center mtb:flex-col-reverse">
        <div className="flex w-[50%] mtb:w-full mtb:mt-10 mtb:mb-5 justify-center items-center flex-col">
          <div className="flex items-center">
            <p className='w-[40px] h-[1.3px] bg-[#414141] mtb:w-[75px] lm:w-[65px]'></p>
          ...
          <h1 className='font-bold first-letter:text-4xl mt-2 mtb:text-xl mtb:first-letter:text-5xl'>Fastest Delivery Ever</h1>
